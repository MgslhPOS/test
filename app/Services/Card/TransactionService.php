...
class TransactionService
{
    ...
    /**
     * Deletes the last transaction for a given card identifier and partner.
     *
    ...
    {
        // Fetch the last transaction for the given card identifier and partner
        ...
        if (!$transaction) {
            return false; // No transaction found to delete
        }

        // Delete the last added analytic for this transaction
